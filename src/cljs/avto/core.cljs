...
(defonce app-state (atom {:state 0 :object {:region "77" :horsepower 100 :run 100000 :manufacture "" :onemonthprice 0.0 :onedayprice 0.0 :twomonthprice 0.0 :minprice 0.0 :maxprice 0.0}}))
